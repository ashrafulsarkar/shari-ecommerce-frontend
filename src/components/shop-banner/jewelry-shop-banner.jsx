...
// BannerItem
function BannerItem({ cls, bg_clr, bg, content, title,link,isBtn=false}) {
  return (
            ...
            <div className="col-xl-6 col-lg-7">
              <div className="row">
                <div className="col-xl-12">
                  <BannerItem cls="mb-25" bg_clr="F3F7FF" bg={banner_bg_1} content=""
                  title={<>TRENDING </>} isBtn={true} link="/shop?category=tranding" />
                </div>
                <div className="col-md-6 col-sm-6">
                <BannerItem cls="has-green sm-banner" bg_clr="F0F6EF" bg={banner_bg_2} content="NEW ARRIVALS " isBtn={true} link="/shop" title="" />

                </div>
                <div className="col-md-6 col-sm-6">
                <BannerItem cls="has-brown sm-banner" bg_clr="F8F1E6" bg={banner_bg_3} content="EID COLLECTION" isBtn={true} link="/shop?category=eid-collection" title="" />
                </div>
              </div>
            </div>
              ...
              <div className="tp-banner-full tp-banner-full-height fix p-relative z-index-1">
                ...
                <div className="tp-banner-full-content">
                  ...
                  <h3 className="tp-banner-full-title">
                    <Link href="/shop?category=boishakh-collection">BOISHAKH COLLECTION </Link>
                  </h3>
